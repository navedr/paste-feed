...
import { Connector } from "../FeedConnector";
...
export function NotificationToggleComponent(props: NotificationToggleProps) {
                ...
                if (subscription === null) {
                    Subscribe(vapid)
                        .then(subscription => {
                            ...
                            Connector.AddSubscription(feedName, JSON.stringify(subscription)).then(() => {
                                setLoading(false);
                            });
                            return;
                        })
                    ...
                    Unsubscribe()
                        .then(() => {
                            Connector.RemoveSubscription(feedName, JSON.stringify(subscription)).then(() => {
                                setLoading(false);
