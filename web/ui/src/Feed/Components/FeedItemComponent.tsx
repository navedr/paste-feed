...
import { copyImageItem, FeedItemContext, FeedItemImageComponent, FeedItemTextComponent } from ".";
...
function HeadingComponent(props: FeedItemHeadingComponentProps) {
...
export function FeedItemComponent(props: FeedItemComponentProps) {
    const item = useContext(FeedItemContext);
    ...
    if (!item) {
        return (
            <Card mt="2em" withBorder shadow="sm" radius="md" mb="2em">
                <HeadingComponent onDelete={props.onDelete} clipboardContent={textContent} />
    ...
    return (
        <Card withBorder shadow="sm" radius="md" mb="2em">
            <HeadingComponent onDelete={props.onDelete} clipboardContent={content} />
            {content && item.type === 0 && <FeedItemTextComponent content={content} type={type} />}
            {item.type === 1 && <FeedItemImageComponent />}
            {item.type === 2 && <Space />}
        </Card>
    );
}
